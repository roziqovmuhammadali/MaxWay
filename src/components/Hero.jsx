...
const Hero = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        setProducts(response.data.slice(99, 100));
      })
      .catch((error) => {
  ...
  return (
    <div className="sm:px-[20px] md:px-[40px] hover:shadow-3xl hover:shadow-gray-950 lg:px-[40px] xl:px-[120px] p-[10px]">
        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="w-full h-full p-4 space-y-3">
              <h1 className=" text-[18px] font-bold">{product.productName}</h1>
