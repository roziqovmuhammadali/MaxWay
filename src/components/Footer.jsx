...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-[#eef0f2] bg-white py-8 sm:px-[10px] md:px-[40px] lg:px-[40px] xl:px-[120px]">
      <div className="">
        <div className="  sm:px-4 mb-10  lg:flex xl:flex 2xl:flex items-center justify-between">
          <NavLink to="/">
          ...
          <ul className=" gap-8 md:items-center lg:flex xl:flex ">
            <li>
              <NavLink to="/branches">
